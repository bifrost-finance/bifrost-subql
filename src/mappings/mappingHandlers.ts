...
const DexTokens = [
  {
    ...
    decimal: 12,
    dex_address: [
      ["5EYCAe5ViNAoHnU1ZZAMeuwFRzWVSR8nXc92oKzfVm5Mqh7Q", { vsToken: "KSM" }],
    ],
  },
  {
    id: "KSM-dex",
  ...
  },
  {
    ...
    decimal: 18,
    dex_address: [
      ["5EYCAe5ViNAoHnU1ZZAKfoyy3zaPgXQF31qreBoKBD5ZuYrM", { Token: "ZLK" }],
    ],
  },
  {
    id: "BNC-dex",
  ...
  },
  {
    ...
    decimal: 12,
    dex_address: [
      ["5EYCAe5ViNAoHnU1ZZAJu3bwfpqQ7zTeBZ4VWBYvzNsXugiH", { Stable: "KUSD" }],
    ],
  },
];
      ...
      if (token.id == "BNC-dex") {
        ...
        JSON.parse(JSON.stringify(tokens_accounts_result)).forEach((item) => {
          token_total_issuance = new BigNumber(
            BigInt(item.data.free).toString()
          );
        });
      } else {
        const tokens_accounts_result = await Promise.all(
